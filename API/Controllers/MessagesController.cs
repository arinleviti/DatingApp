...
[Authorize]
public class MessagesController (/* IunitOfWork.MessageRepository unitOfWork.MessageRepository, IunitOfWork.UserRepository unitOfWork.UserRepository, */ IUnitOfWork unitOfWork, IMapper mapper) : BaseClassController
{
    [HttpPost]
